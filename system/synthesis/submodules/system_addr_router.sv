...
(
    ...
    localparam PAD2 = log2ceil(64'h110c0 - 64'h11080); 
    localparam PAD3 = log2ceil(64'h11100 - 64'h110c0); 
    ...
    localparam PAD8 = log2ceil(64'h11190 - 64'h11188); 
    // -------------------------------------------------------
    ...
    // ( 0x11140 .. 0x11150 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 17'h11140   ) begin
            src_channel = 9'b100000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0x11150 .. 0x11160 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 17'h11150   ) begin
            src_channel = 9'b010000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 0;
    end

    // ( 0x11160 .. 0x11170 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 17'h11160   ) begin
            src_channel = 9'b001000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
    end

    // ( 0x11170 .. 0x11180 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 17'h11170   ) begin
            src_channel = 9'b000100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 3;
    end

    // ( 0x11188 .. 0x11190 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 17'h11188   ) begin
